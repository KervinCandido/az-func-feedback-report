...
You can then execute your native executable with: `./target/az-func-feedback-report-1.0.0-SNAPSHOT-runner`
...
- Quarkus Support Azure Blob Storage ([guide](https://docs.quarkiverse.io/quarkus-azure-services/dev/quarkus-azure-storage-blob.html)): Interacts with Azure Blob Storage through the Azure SDK for Java
